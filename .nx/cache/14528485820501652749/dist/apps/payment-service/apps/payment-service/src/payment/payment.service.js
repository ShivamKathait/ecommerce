...
let PaymentService = PaymentService_1 = class PaymentService {
    ...
    async createPaymentIntent(amount, currency, orderId, userId, customerId, idempotencyKey) {
        ...
        const intent = await this.stripe.paymentIntents.create({
            ...
            idempotencyKey: idempotencyKey ??
                this.buildDeterministicKey('payment-intent', `${orderId}:${userId}:${amount}:${normalizedCurrency}`),
        });
        return {
            id: intent.id,
