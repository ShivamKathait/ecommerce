...
let PaymentController = class PaymentController {
    ...
    async createCustomer(dto, idempotencyKey) {
        const customerId = await this.paymentService.createCustomer(dto.name, dto.email, idempotencyKey);
        return { data: { customerId } };
    }
    async createConnectAccount(dto, idempotencyKey) {
        const accountId = await this.paymentService.createConnectAccount(dto.email, dto.userId, idempotencyKey);
    ...
    async createOnboardingLink(accountId, dto) {
        const url = await this.paymentService.generateOnboardingLink(accountId, dto.vendorId, dto.userId);
        return { data: { url } };
    }
    async createPaymentIntent(dto, idempotencyKey) {
        const paymentIntent = await this.paymentService.createPaymentIntent(dto.amount, dto.currency, dto.orderId, dto.userId, dto.customerId, idempotencyKey);
...
__decorate([
    ...
    __param(1, (0, common_1.Headers)('idempotency-key')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_connect_account_dto_1.CreateConnectAccountDto, String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Headers)('idempotency-key')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_payment_intent_dto_1.CreatePaymentIntentDto, String]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "createPaymentIntent", null);
__decorate([
    (0, common_1.Get)('intents/:paymentIntentId'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a Stripe payment intent' }),
...
exports.PaymentController = PaymentController = __decorate([
    ...
    (0, common_1.UseGuards)(internal_service_guard_1.InternalServiceGuard),
