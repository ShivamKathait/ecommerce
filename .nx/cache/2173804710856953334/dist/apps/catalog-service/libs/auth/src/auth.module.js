...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [jwt_strategy_1.JwtStrategy, temp_jwt_strategy_1.TempStrategy, jwt_auth_guard_1.JwtAuthGuard, temp_auth_guard_1.TempAuthGuard, roles_guard_1.RolesGuard],
        exports: [jwt_1.JwtModule, passport_1.PassportModule, jwt_auth_guard_1.JwtAuthGuard, temp_auth_guard_1.TempAuthGuard, roles_guard_1.RolesGuard],
    })
], AuthModule);
