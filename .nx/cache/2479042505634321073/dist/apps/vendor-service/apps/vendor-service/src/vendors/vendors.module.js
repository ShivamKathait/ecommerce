...
exports.VendorsModule = VendorsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            axios_1.HttpModule,
            jwt_1.JwtModule,
            typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, session_entity_1.Session, vendor_profile_entity_1.VendorProfile])
        ],
        controllers: [vendors_controller_1.VendorsController],
        providers: [vendors_service_1.VendorsService, auth_1.AuthService, payment_client_service_1.PaymentClientService],
    })
], VendorsModule);
