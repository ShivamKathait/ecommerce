...
exports.AppDataSource = (0, db_1.createPostgresDataSource)([user_entity_1.User, session_entity_1.Session, product_entity_1.Product], ['libs/db/migrations/catalog-service/*.ts']);
