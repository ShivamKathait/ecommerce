...
let UsersController = class UsersController {
    ...
    verify_otp(dto, req) {
        return this.usersService.verify_otp(dto, req.user);
    }
    login(dto) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(auth_1.TempAuthGuard, auth_1.RolesGuard),
    (0, common_1.Patch)('verify/otp'),
    (0, swagger_1.ApiConsumes)('application/json', 'application/x-www-form-urlencoded'),
    (0, swagger_1.ApiOperation)({ summary: `User Verify Otp Api` }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_user_dto_1.OtpDto, Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "verify_otp", null);
__decorate([
